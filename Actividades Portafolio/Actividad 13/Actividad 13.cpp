...
void elimMisterio() {
    ...
    if(q == NULL)
        ...
        q->sig = p->sig;
    delete(p);
    cout << "Un libro de misterio ha sido borrado!" << endl;
}
    ...
    do{
        ...
        switch(opcion){
            ...
            case 5: cout << "Buscando..." << endl;
                if(buscarEspanol())
                    cout << "Existen libros en Espanol" << endl;
                else
                    cout << "No existen libros en Espanol" << endl;
                break;
            case 6: cout << "Buscando..." << endl;
                if(buscarCFiccion())
                    cout << "Existen libros de Ciencia Ficcion" << endl;
                else
                    cout << "No existen de Ciencia Ficcion" << endl;
                break;
            case 7: (elimMisterio());
                break;
